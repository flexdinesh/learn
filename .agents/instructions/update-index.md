...
5. Update the `Available HTML pages` section in `README.md` with a Markdown link for every path. Preserve unrelated README content.
...
Do not add external scripts, styles, or assets to `index.html`.
